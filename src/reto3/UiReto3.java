...
public class UiReto3 {
	...
	private void construccionTablaProductos() {
		
		TableModel modeloDatosProductos = new DatosProductos();
		
		// creacion de tabla
		tableProductos = new JTable(modeloDatosProductos);
	...
	private void construirPanelTablaProductos() {

		panelCenter = new JPanel();
		panelCenter.setLayout(new BorderLayout(5, 5));
		frame.getContentPane().add(panelCenter, BorderLayout.CENTER);

		construccionTablaProductos();
